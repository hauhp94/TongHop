...
<body>
	...
	<div class="container">
		<h3 class="justify-content-center d-flex text-primary">Sửa đăng ký</h3>

		<form:form action="/dangKyLamThem/edit" method="post" class="border p-3 bg-light"
			modelAttribute="dangKyLamThemDto">
			<div class="row">
				<div class="form-group col-6 col-sm-6">
					<label for="maDK">Mã đăng ký</label>
					<form:input path="maDK" class="form-control" readonly="true"/>
				...
				<div class="form-group col-6 col-sm-6">
					...
					<form:input type="text" path="soNgayCong" class="form-control"
