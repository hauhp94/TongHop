...
<body>
	...
	<div class="container">
		<h3 class="justify-content-center d-flex text-primary">Tạo mới máy</h3>
		<form class="border p-3 bg-light" action="computer" method="post">
			<input type="hidden" name="action" value="create">
			<div class="row ">
				<div class="form-group col-6 col-sm-6">
					<label for="maMay">Mã máy</label> <input type="text"
						class="form-control" name="maMay" id="maMay"
				...
				<div class="form-group col-6 col-sm-6">
					<label for="viTri">Vị trí</label> <input type="text"
						class="form-control" name="viTri" id="viTri"
						aria-describedby="helpId" placeholder=""> <small
						id="helpId" class="form-text text-muted">Help text</small>
				</div>
				<div class="form-group col-6 col-sm-6">
					<label for="trangThai">Trạng thái</label> <input type="text"
						class="form-control" name="trangThai" id="trangThai"
						aria-describedby="helpId" placeholder=""> <small
						id="helpId" class="form-text text-muted">Help text</small>
				</div>
			</div>
